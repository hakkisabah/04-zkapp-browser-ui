...
function Home() {
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        (async ()=>{
            ...
            // Berkeley Testnet B62qm9bg2vbmifhKEaU3pCZNo3QELNFdBNaJBqppwajkR6wdGt37SJM
            const zkAppAddress = "";
            // This should be removed once the zkAppAddress is updated.
            if (!zkAppAddress) {
                console.error('The following error is caused because the zkAppAddress has an empty string as the public key. Update the zkAppAddress with the public key for your zkApp account, or try this address for an example "Add" smart contract that we deployed to Berkeley Testnet: B62qm9bg2vbmifhKEaU3pCZNo3QELNFdBNaJBqppwajkR6wdGt37SJM');
            }
